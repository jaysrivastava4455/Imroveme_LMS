...
<div class="w3-content" style="max-width:1100px">
  ...
  <?php if ($user['roleid']  == 1 || $user['roleid']  == 2) { ?>
    <div><strong>user display:</strong> here get all the user </div><br>
    ...
    foreach ($members as $member) {
      ...
      echo "<td>
    <a href='editUser.php?id=" . $member['id'] . "' title='Edit'>edit</a> 
    <a href='deleteUser.php?id=" . $member['id'] . "' title='Delete' onclick=\"return confirm('Are you sure you want to delete this user?');\">delete</a>
  </td>";
      echo "</tr>";
    }
    echo "</table>";
